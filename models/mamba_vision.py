...
def make_model(args):
    return MambaVision(dim = , in_dim=, depths= , window_size=, mlp_ratio= , num_heads= )
...
def window_partition(x, window_size):
    ...
    windows = x.permute(0, 2, 4, 3, 5, 1).reshape(-1, window_size * window_size, C) # TODO 同一batch的被混合到一起了
    return windows
